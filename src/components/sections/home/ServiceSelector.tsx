...
const panels: [ServicePanel, ServicePanel] = [
  {
    ...
    cta: "Vstúpiť",
    image: {
      src: "/images/home/detailing-bg.jpg",
      alt: "Auto detailing — prémiová starostlivosť o vozidlo",
    },
    theme: "detailing",
  },
  {
    ...
    cta: "Vstúpiť",
    image: {
      src: "/images/home/pneuservis-bg.jpg",
      alt: "Pneuservis — prezutie a starostlivosť o pneumatiky",
    },
    theme: "pneuservis",
  },
];
  ...
  return (
    ...
    >
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-black/62 transition-colors duration-500 group-hover:bg-black/52" />
        <div
          className={cn(
      ...
      <div className="relative flex h-full w-full flex-col items-center justify-center p-6 text-center sm:p-8 md:p-10">
        <div className="mx-auto max-w-md">
          <h2 className="text-[clamp(2.4rem,5.5vw,4.5rem)] font-extrabold tracking-[0.06em] text-white">
            {panel.title}
          </h2>
          <p className="mx-auto mt-4 max-w-xs text-pretty text-sm leading-relaxed text-white/70 sm:text-base">
            {panel.supporting}
          </p>
